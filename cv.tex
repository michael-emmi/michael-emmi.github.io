...
\begin{document}
  ...
  {\noindent\bfseries\Large Principal Applied Scientist} \\[1em]
  \noindent
  ...
  \begin{description}[leftmargin=0cm]
    ...
    https://conf.researchr.org/home/splash-issta-2026/sas-2026}{%
    33rd Static Analysis Symposium} (SAS ’26).


    \item[Program Committee.] \href{%
    https://conferences.i-cav.org/2025/}{%
    37th International Conference on Computer Aided Verification} (CAV ’25).
  ...
  \begin{itemize}[leftmargin=0cm,label={}]
    ...
    Compositional Taint Analysis for Enforcing Security Policies at Scale.}} In \emph{ 31st ACM Joint European Software Engineering Conference and Symposium on the Foundations of Software Engineering } (ESEC/FSE ’23). ACM, 2023. (\href{https://michael-emmi.github.io/https://github.com/michael-emmi/research-papers/raw/master/conf-sigsoft-BanerjeeCEFHLLPRSTW23.pdf}{PDF})
